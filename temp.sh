...
run_candidate() {
  ...
  echo "=== [$TAG] Phase 3: 12-month compare-fixed with Optuna best ==="
  uv run backtester compare-fixed \
    --data-dir data \
    --primary-timeframe 1h \
    --strategy "$STRATEGY" \
...
run_candidate vwap_reclaim strategies/backtester/crypt_ensemble_h1_discovery_vwap_reclaim_robust.json
